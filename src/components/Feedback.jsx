...
function FeedbackButton(props) {
  return (
    <button
      type="submit"
      className="px-3 text-sm font-medium text-neutral-600 transition hover:bg-neutral-900/2.5 hover:text-neutral-900 dark:text-neutral-400 dark:hover:bg-white/5 dark:hover:text-white"
      {...props}
    />
  )
}
...
const FeedbackThanks = forwardRef(function FeedbackThanks(
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-yellow-50/50 py-1 pl-1.5 pr-3 text-sm text-yellow-500 ring-1 ring-inset ring-yellow-500/20 dark:bg-yellow-500/5 dark:text-yellow-200 dark:ring-yellow-500/30">
