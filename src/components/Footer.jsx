...
const navigation = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=61558126626290',
    icon: (props) => (
  ...
  {
    name: 'YouTube',
    href: 'https://www.youtube.com/channel/UChpWecDqRs1v6l8QeQLG0Yw',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
...
export default function Footer() {
  return (
    <footer className="bg-JonesCo-Red-50">
