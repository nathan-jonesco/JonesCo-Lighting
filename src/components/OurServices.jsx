    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-base font-semibold leading-7 text-JonesCo-Red-400">Comprehensive Cleaning Services</h2>
            ...
            >
              <Link href={service.link}> 
                <dt className="inline font-black text-white">
                  <service.icon className="absolute left-1 top-1 h-5 w-5 text-JonesCo-Red-400" aria-hidden="true" />
                  {service.name}
                </dt>{' '}
